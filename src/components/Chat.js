...
import { addMessage, removeMessage, addChat } from '../actions/chatActions';
...
class Chat extends React.Component {
  ...
  createChat = participants => {
    this.props.dispatch(createChat({ participants }, this.props.history));
    this.toggle();
  };
        ...
        <Row noGutters>
          ...
          <Col sm="9" xs={12}>
            <Route
              ...
              render={props => (
                <ChatDetails {...props} chat={this.props.chat} />
              )}
            />
          </Col>
        </Row>
